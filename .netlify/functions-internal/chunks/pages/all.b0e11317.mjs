...
const $$file$2 = "C:/Users/user/Documents/Development/adcombo/pinup4-kz/src/pages/index.astro";
const $$url$2 = "";
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": post.seo.title, "description": post.seo.metaDesc }, { "default": ($$result2) => renderTemplate`
